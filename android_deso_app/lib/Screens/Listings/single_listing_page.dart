...
class SingleListingDetails extends StatefulWidget {
  SingleListingDetails({Key? key, required this.temp}) : super(key: key);

  Listing temp;

  @override
  State<SingleListingDetails> createState() => _SingleListingDetailsState();
}

class _SingleListingDetailsState extends State<SingleListingDetails> {
  ...
  void openDialog() => showDialog(
    ...
    builder: (context) {
      ...
      return AlertDialog(
        content: Text("Item has been unlisted",
